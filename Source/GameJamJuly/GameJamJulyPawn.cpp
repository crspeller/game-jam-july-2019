...
AGameJamJulyPawn::AGameJamJulyPawn()
{
...
void AGameJamJulyPawn::Tick(float DeltaSeconds)
{
...
void AGameJamJulyPawn::NotifyHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AGameJamJulyPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AGameJamJulyPawn::MoveUpInput(float Val)
{
...
void AGameJamJulyPawn::MoveRightInput(float Val)
{
